...
public class HotelOperationModule {
    ...
    private void doViewRoomAllocationExceptionReport() {
        ...
        for(RoomAllocationExceptionReport report: reports){
            ...
            System.out.print(outputFormat.format(report.getReservationLineItem().getReservation().getCheckIn()));
            
            System.out.println("");
            
            System.out.print("Check Out Date> ");
            System.out.print(outputFormat.format(report.getReservationLineItem().getReservation().getCheckOut()));
            ...
            case 3:
                {
                    ...
                    while (true) {
                        ...
                        Date date;
                        try {
                            date = inputDateFormat.parse(sc.nextLine().trim());
                            
                            validateDate.add(date);
            ...
            case 4:
                {
                    ...
                    Date validityPeriodEnd = new Date();
                    ...
                    while(true){
                        ...
                        try {
                            ...
                            promotionRoomRate.setValidityPeriodStart(date1);
                            break;
                        } catch (ParseException ex) {
                    ...
                    while(true){
                        ...
                        try {
                            ...
                            promotionRoomRate.setValidityPeriodEnd(date2);
                            break;
                        } catch (ParseException ex) {
                            Logger.getLogger(HotelOperationModule.class.getName()).log(Level.SEVERE, null, ex);
                        }       
    ...
    private void doViewRoomRateDetails() {
        ...
        try {
            ...
            if (roomRate instanceof PeakRoomRate) {
                ...
                List<Date> list = ((PeakRoomRate)roomRate).getValidityDates();
                for (Date date : list) {
            ...
            if (roomRate instanceof PromotionRoomRate) {
                ...
                Date date1 = ((PromotionRoomRate)roomRate).getValidityPeriodStart();
                System.out.print(dateFormat.format(date1));
                System.out.print("\n");

                System.out.print("Validitity Period End Date> ");
                Date date2 = ((PromotionRoomRate)roomRate).getValidityPeriodEnd();
                System.out.print(dateFormat.format(date2));
                System.out.print("\n");
                ...
                if (sc.hasNext()) {
                    while (true) {
                        ...
                        try {
                            ...
                            ((PromotionRoomRate) roomRate).setValidityPeriodStart(date1);
                            break;
                        } catch (ParseException ex) {
                            Logger.getLogger(HotelOperationModule.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                if (sc.hasNext()) {
                    while (true) {
                        ...
                        try {
                            ...
                            ((PromotionRoomRate) roomRate).setValidityPeriodEnd(date2);
                            break;
                        } catch (ParseException ex) {
                            Logger.getLogger(HotelOperationModule.class.getName()).log(Level.SEVERE, null, ex);
                        }
