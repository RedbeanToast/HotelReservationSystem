...
public class MainApp {
    ...
    private void doMenu() throws SearchHotelRoomsException {
        Scanner sc = new Scanner(System.in);
        int response = 0;
        while (true) {
            ...
            while (response < 1 || response > 4) {
                ...
                response = sc.nextInt();
                if (response == 1) {
                    HolidayReservation.doSearchHotelRoom(registerGuest);
                } else if (response == 2) {
                    HolidayReservation.doViewReservationDetails(registerGuest);
                } else if (response == 3) {
                    HolidayReservation.doViewAllReservations(registerGuest);
                } else if (response == 4) {
                    break;
                } else {
